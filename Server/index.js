...
// Rota para obter todos os itens do sistema
// app.get('/Adm', (req, res) => {
//   lerArquivoJSON((err, data) => {
//     if (err) {
//       return res.status(500).json({ error: 'Erro ao ler os itens do sistema' });
//     }
//     res.json(data); // Retorna todos os itens do arquivo JSON
//   });
// });
